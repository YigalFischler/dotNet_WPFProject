...
namespace DAL
{
    /*public static class FactoryDAL_XML
    {
        private static Idal_XML dal_XML;
        public static Idal_XML Instance()
        {
            return dal_XML ?? (dal_XML = new Dal_XML_imp());
        }
    }*/

    public interface Idal_XML
    {
        /// <summary>
